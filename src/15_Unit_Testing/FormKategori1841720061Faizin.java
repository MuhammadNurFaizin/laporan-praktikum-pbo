...
public class FormKategori1841720061Faizin extends javax.swing.JFrame {

    /**
     * Creates new form FormKategori
     */
    public FormKategori1841720061Faizin() {
        initComponents();
        tampilData();
        kosongkanForm();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormKategori1841720061Faizin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormKategori1841720061Faizin().setVisible(true);
            }
        });
    }
