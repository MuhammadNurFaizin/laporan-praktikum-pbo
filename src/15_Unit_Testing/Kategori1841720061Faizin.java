...
public class Kategori1841720061Faizin {
    ...
    public ArrayList<Kategori1841720061Faizin> getByNamaAndKeterangan(String nama, String keterangan) {
        ArrayList<Kategori1841720061Faizin> ListKategori = new ArrayList();
        ResultSet rs;
        if ((nama.trim().length() > 0) && (keterangan.trim().length() > 0)) {
            ...
            rs = DBHelper1841720061Faizin.selectQuery("SELECT * FROM kategori Where nama = '" + nama + "'");
        } else {
            rs = DBHelper1841720061Faizin.selectQuery(
            "SELECT * FROM kategori "
